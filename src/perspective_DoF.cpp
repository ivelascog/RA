 ...
 */
	class PerspectiveCameraDoF : public Camera {
	public:
		PerspectiveCameraDoF(const PropertyList &propList) {
			...
			m_lensRadius = propList.getFloat("lensRadius");
		}
...
NORI_REGISTER_CLASS(PerspectiveCameraDoF, "perspective_dof");
NORI_NAMESPACE_END
