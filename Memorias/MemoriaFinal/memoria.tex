...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{images/escena_2400x1800_128spp_dof0-0.png}
...
%\begin{figure}[h]
%\centering
%\includegraphics[width=1\linewidth]{images/escena_2400x1800_128spp_dof20-03.png}
%\caption{Render con DoF: Distancia focal: 20, Radio lente: 0.3}
%\label{fig:disp}
%\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{images/escena_2400x1800_128spp_dof20-1.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{images/escena_2400x1800_2048spp_dof20-03.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{images/escenamirror_2400x1800_2048spp_dof20-03.png}
